...
import ruletaImg from "../assets/ruleta/ruleta_2_7.png";
import flechaImg from "../assets/ruleta/flecha.png";
import botonGirarImg from "../assets/botones/girar.png";

const SECTORES_RUEDA = [
    { id: 1, nombre: "Lengua y literatura", ruta: "lengua-y-literatura" },
    { id: 2, nombre: "Enseñanzas Religiosas", ruta: "ensenanzas-religiosas" },
    { id: 3, nombre: "Ciencias Naturales", ruta: "ciencias-naturales" },
    { id: 4, nombre: "Estudios Sociales", ruta: "estudios-sociales" },
    { id: 5, nombre: "Inglés", ruta: "ingles" },
    { id: 6, nombre: "Matemáticas", ruta: "matematicas" },
];

export default function RuletaBasica({ onFinish }) {
        ...
        function finalizarGiro(anguloFinal) {
            ...
            setTimeout(() => {
                ...
                navigate(`/preguntas/${sectorGanador.ruta}`, {
                    state: { nombreSector: sectorGanador.nombre, origen: "basica", especialidad, curso }
                });
